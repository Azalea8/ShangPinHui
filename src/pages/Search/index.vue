...
export default {
  ...
  watch: {
    $route: {
      handler(newV, oldV) {
        console.log('Search组件捕获到路由变化~')
        this.searchParams.catagory1id = ''
        this.searchParams.catagory2id = ''
        this.searchParams.catagory3id = ''
  ...
  methods: {
    ...
    removeCatagoryName() {
      let ref = {
        ...
        catagory2id: undefined,
        catagory1id: undefined,
